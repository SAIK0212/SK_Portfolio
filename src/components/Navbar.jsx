    ...
    >
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        >
          ...
          <p className='text-white text-[29px] font-bold cursor-pointer flex items-center -ml-2'>
            AIKIRAN U S
          </p>
        </Link>
        ...
        <ul className='list-none hidden sm:flex flex-row gap-10'>
          {navLinks.map((nav) => (
            <li
              ...
              } neon-flicker text-[18px] font-medium cursor-pointer hover:text-white hover:drop-shadow-[0_0_20px_#a855f7]`}
